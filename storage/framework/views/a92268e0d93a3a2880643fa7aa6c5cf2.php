...
<div class="d-flex justify-content-end mb-4">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="firstName" value="<?php echo e($etudiant->firstName); ?>">
  </div>

  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label" >Nom</label>
    <input type="text" class="form-control" name="lastName" value="<?php echo e($etudiant->lastName); ?>">
  </div>
  <div class="mb-3">
...
<?php echo $__env->make("layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MARINA La Lionne\Desktop\LARAVEL\FirstProject\resources\views/editEtudiant.blade.php ENDPATH**/ ?>